            ...
            <div className="about__wrapper">
                ...
                <div className="flex-c about__content">
                    <div className="about__text">
                        ...
                        <p className="about__links-wrap">Find me on <a href="https://www.linkedin.com/in/monica-zarate/" title="Monica Zarate's LinkedIn Profile" target="_blank" rel="noreferrer" className="about__links">LinkedIn</a> or send me an <a href="mailto:hello@monicazarate.com" title="Send me an email: hello@monicazarate.com" target="_blank" rel="noreferrer" className="about__links">email</a>.</p>
                    </div>
